export declare const homepagePromoBannerSeeds: readonly [{
    readonly slug: "electrical-essentials";
    readonly eyebrow: "Industrial Supply";
    readonly title: "Electrical Essentials";
    readonly subtitle: "Switchgear and motor control inventory";
    readonly imageUrl: "/images/landing-top-1.jpg";
    readonly status: "published";
    readonly sortOrder: 0;
}, {
    readonly slug: "plant-safety-readiness";
    readonly eyebrow: "Industrial Supply";
    readonly title: "Plant Safety Readiness";
    readonly subtitle: "PPE and compliance products in stock";
    readonly imageUrl: "/images/landing-top-2.jpg";
    readonly status: "published";
    readonly sortOrder: 1;
}, {
    readonly slug: "fastener-bulk-supply";
    readonly eyebrow: "Industrial Supply";
    readonly title: "Fastener Bulk Supply";
    readonly subtitle: "High-volume hardware replenishment";
    readonly imageUrl: "/images/landing-top-3.jpg";
    readonly status: "published";
    readonly sortOrder: 2;
}];
export declare const homepageCategoryTileSeeds: readonly [{
    readonly slug: "electrical";
    readonly label: "Electrical";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 0;
}, {
    readonly slug: "mechanical";
    readonly label: "Mechanical";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 1;
}, {
    readonly slug: "safety";
    readonly label: "Safety";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 2;
}, {
    readonly slug: "fasteners";
    readonly label: "Fasteners";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 3;
}, {
    readonly slug: "pneumatics";
    readonly label: "Pneumatics";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 4;
}, {
    readonly slug: "hydraulics";
    readonly label: "Hydraulics";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    ...
    readonly slug: "material-handling";
    readonly label: "Material Handling";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 7;
}, {
    readonly slug: "power-transmission";
    readonly label: "Power Transmission";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    ...
    readonly slug: "facility-maintenance";
    readonly label: "Facility Maintenance";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 10;
}, {
    readonly slug: "welding";
    readonly label: "Welding";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 11;
}, {
    readonly slug: "bearings";
    readonly label: "Bearings";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 12;
}, {
    readonly slug: "belts-chains";
    readonly label: "Belts & Chains";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 13;
}, {
    readonly slug: "motors";
    readonly label: "Motors";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 14;
}, {
    readonly slug: "valves";
    readonly label: "Valves";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 15;
}, {
    readonly slug: "sensors";
    readonly label: "Sensors";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 16;
}, {
    readonly slug: "controls";
    readonly label: "Controls";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 17;
}, {
    readonly slug: "lubrication";
    readonly label: "Lubrication";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 18;
}, {
    readonly slug: "safety-signs";
    readonly label: "Safety Signs";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
    readonly sortOrder: 19;
}, {
    readonly slug: "cleaning-supplies";
    readonly label: "Cleaning Supplies";
    readonly imageUrl: "/images/category-tile.svg";
    readonly status: "published";
