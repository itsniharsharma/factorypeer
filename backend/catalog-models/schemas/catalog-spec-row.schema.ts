...
import type { PublishStatus, VariantBindingRole } from "../enums.js";
...
const variantBindingSchema = new Schema(
  {
    ...
    role: {
      type: String,
      enum: ["primary", "alternate"] satisfies VariantBindingRole[],
      default: "primary",
    },
...
export type CatalogSpecRowDocument = InferSchemaType<
  typeof catalogSpecRowSchema
> & { _id: Types.ObjectId };
